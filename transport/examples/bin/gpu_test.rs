...
#[cfg(feature = "cuda")]
fn run_async_gpu_test(producer: &mut transport::Producer, n_messages: u32) -> Result<(), Box<dyn std::error::Error>> {
    use transport::buffer::gpu_arena::GpuTextArena;
    ...
    for i in 0..n_messages {
        ...
        let flags = (i % 256) as u8;  // Simple test pattern
        arena.add_text(text.as_bytes(), flags)?;
    }
