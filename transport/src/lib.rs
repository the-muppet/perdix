//! # Perdix Transport - High-Performance GPU-Accelerated Ring Buffer
//! 
...
//! producer.try_produce(b"Hello from Perdix!");
//!
...
// Re-export key types
pub use buffer::ffi::StreamContext;  // Generic streaming context
pub use buffer::{Buffer, Consumer, Header, Producer, Slot, Message};
