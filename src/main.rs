use perdixlib::{AgentType, Buffer, StreamContext};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let consumer_handle = thread::spawn(move || {
        ...
        while !stop_clone.load(Ordering::Relaxed) {
            ...
            if last_report.elapsed() > Duration::from_secs(1) {
                ...
                println!(
                    "[Consumer] Stats: consumed={}, available={}",
        ...
        println!(
            "[Consumer] Thread stopping. Total consumed: {}",
            total_consumed
        );
        total_consumed
    });
    ...
    #[cfg(feature = "cuda")]
    {
        ...
        let contexts: Vec<StreamContext> = agents
            .iter()
